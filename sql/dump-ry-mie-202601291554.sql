...
VALUES (1, 104, 1, 3, '很不错，超级赞。', '2026-01-23 11:22:50');
/*!40000 ALTER TABLE `mall_comment`
    ENABLE KEYS */;
UNLOCK TABLES;
...
VALUES (1, 101, '爱他美奶粉', '爱他美（Aptamil）卓傲较大婴儿配方奶粉2段（6—12月龄）800g*6罐  爱他美卓傲',
        '/profile/upload/2026/01/22/微信图片_20260122160928_221_114_20260122160953A001.jpg', 188.00, 200.00, 97, 13,
...
VALUES (1, '20260122164149E2412D', 104, 188.00, '0', '0', '范加', '13098978788', '陕西省', '2026-01-22 16:41:49'),
       ...
       (3, '20260127103907575013', 104, 188.00, '0', '0', '李四维', '13098987876', '北京市西城区',
        '2026-01-27 10:39:08');
/*!40000 ALTER TABLE `mall_order`
    ENABLE KEYS */;
UNLOCK TABLES;
...
VALUES (1, 104, 1, '2026-01-27 10:39:16');
/*!40000 ALTER TABLE `mall_view_log`
    ENABLE KEYS */;
UNLOCK TABLES;
...
VALUES (100, 'admin', '127.0.0.1', '内网IP', 'Chrome 12', 'Windows 10', '0', '登录成功', '2024-02-28 22:39:55'),
       ...
       (315, 'admin', '127.0.0.1', '内网IP', 'Chrome 14', 'Windows 10', '0', '登录成功', '2026-01-23 11:20:16'),
       (316, 'admin', '127.0.0.1', '内网IP', 'Chrome 14', 'Windows 10', '0', '退出成功', '2026-01-23 11:22:12'),
       (317, 'zhangsan', '127.0.0.1', '内网IP', 'Chrome 14', 'Windows 10', '0', '登录成功', '2026-01-23 11:22:21'),
       (318, 'zhangsan', '127.0.0.1', '内网IP', 'Chrome 14', 'Windows 10', '0', '退出成功', '2026-01-23 11:22:55'),
       (319, 'admin', '127.0.0.1', '内网IP', 'Chrome 14', 'Windows 10', '0', '登录成功', '2026-01-23 11:22:58'),
       (320, 'zhangsan', '127.0.0.1', '内网IP', 'Chrome 14', 'Windows 10', '0', '登录成功', '2026-01-23 15:17:43'),
       (321, 'zhangsan', '127.0.0.1', '内网IP', 'Chrome 14', 'Windows 10', '0', '退出成功', '2026-01-23 15:18:16'),
       (322, 'admin', '127.0.0.1', '内网IP', 'Chrome 14', 'Windows 10', '0', '登录成功', '2026-01-23 15:18:20'),
       (323, 'admin', '127.0.0.1', '内网IP', 'Chrome 14', 'Windows 10', '0', '退出成功', '2026-01-23 15:42:01'),
       (324, 'zhangsan', '127.0.0.1', '内网IP', 'Chrome 14', 'Windows 10', '0', '登录成功', '2026-01-23 15:42:22'),
       (325, 'zhangsan', '127.0.0.1', '内网IP', 'Chrome 14', 'Windows 10', '0', '退出成功', '2026-01-23 15:55:34'),
       (326, 'admin', '127.0.0.1', '内网IP', 'Chrome 14', 'Windows 10', '0', '登录成功', '2026-01-23 15:56:24'),
       (327, 'admin', '127.0.0.1', '内网IP', 'Chrome 14', 'Windows 10', '0', '登录成功', '2026-01-27 10:38:07'),
       (328, 'admin', '127.0.0.1', '内网IP', 'Chrome 14', 'Windows 10', '0', '退出成功', '2026-01-27 10:38:24'),
       (329, 'zhangsan', '127.0.0.1', '内网IP', 'Chrome 14', 'Windows 10', '0', '登录成功', '2026-01-27 10:38:35'),
       (330, 'zhangsan', '127.0.0.1', '内网IP', 'Chrome 14', 'Windows 10', '0', '退出成功', '2026-01-27 10:39:20'),
       (331, 'admin', '127.0.0.1', '内网IP', 'Chrome 14', 'Windows 10', '0', '登录成功', '2026-01-27 10:39:24'),
       (332, 'admin', '127.0.0.1', '内网IP', 'Chrome 14', 'Windows 10', '0', '退出成功', '2026-01-27 10:40:17'),
       (333, 'zhangsan', '127.0.0.1', '内网IP', 'Chrome 14', 'Windows 10', '0', '登录成功', '2026-01-27 10:40:28'),
       (334, 'admin', '127.0.0.1', '内网IP', 'Chrome 14', 'Windows 10', '1', '验证码已失效', '2026-01-27 10:46:55'),
       (335, 'admin', '127.0.0.1', '内网IP', 'Chrome 14', 'Windows 10', '0', '登录成功', '2026-01-27 10:46:58'),
       (336, 'admin', '127.0.0.1', '内网IP', 'Chrome 14', 'Windows 10', '0', '退出成功', '2026-01-29 15:31:45'),
       (337, 'zhangsan', '127.0.0.1', '内网IP', 'Chrome 14', 'Windows 10', '0', '登录成功', '2026-01-29 15:31:53'),
       (338, 'zhangsan', '127.0.0.1', '内网IP', 'Chrome 14', 'Windows 10', '0', '退出成功', '2026-01-29 15:35:30'),
       (339, 'zhangsan', '127.0.0.1', '内网IP', 'Chrome 14', 'Windows 10', '0', '登录成功', '2026-01-29 15:35:45'),
       (340, 'zhangsan', '127.0.0.1', '内网IP', 'Chrome 14', 'Windows 10', '0', '退出成功', '2026-01-29 15:38:14'),
       (341, 'admin', '127.0.0.1', '内网IP', 'Chrome 14', 'Windows 10', '0', '登录成功', '2026-01-29 15:38:18'),
       (342, 'admin', '127.0.0.1', '内网IP', 'Chrome 14', 'Windows 10', '0', '退出成功', '2026-01-29 15:41:42'),
       (343, 'zhangsan', '127.0.0.1', '内网IP', 'Chrome 14', 'Windows 10', '0', '登录成功', '2026-01-29 15:41:58'),
       (344, 'zhangsan', '127.0.0.1', '内网IP', 'Chrome 14', 'Windows 10', '0', '退出成功', '2026-01-29 15:43:26'),
       (345, 'admin', '127.0.0.1', '内网IP', 'Chrome 14', 'Windows 10', '0', '登录成功', '2026-01-29 15:43:30');
/*!40000 ALTER TABLE `sys_logininfor`
    ENABLE KEYS */;
UNLOCK TABLES;
...
VALUES (1, '系统管理', 0, 1, 'system', NULL, '', 1, 0, 'M', '0', '0', '', 'system', 'admin', '2024-02-28 22:23:42', '',
       ...
       (2062, '评论管理', 2056, 4, 'comment', 'mall/comment/index', NULL, 1, 0, 'C', '0', '0', 'mall:comment:list',
        'message', 'admin', '2026-01-23 11:21:50', '', NULL, '');
/*!40000 ALTER TABLE `sys_menu`
    ENABLE KEYS */;
UNLOCK TABLES;
...
VALUES (100, '用户管理', 3, 'com.ruoyi.web.controller.system.SysUserController.remove()', 'DELETE', 1, 'admin',
       ...
       (301, '菜单管理', 1, 'com.ruoyi.web.controller.system.SysMenuController.add()', 'POST', 1, 'admin', 'XXX大学',
        '/system/menu', '127.0.0.1', '内网IP',
        '{\"children\":[],\"component\":\"mall/comment/index\",\"createBy\":\"admin\",\"icon\":\"message\",\"isCache\":\"0\",\"isFrame\":\"1\",\"menuName\":\"评论管理\",\"menuType\":\"C\",\"orderNum\":4,\"params\":{},\"parentId\":2056,\"path\":\"comment\",\"perms\":\"mall:comment:list\",\"status\":\"0\",\"visible\":\"0\"}',
        '{\"msg\":\"操作成功\",\"code\":200}', 0, NULL, '2026-01-23 11:21:50', 18),
       (302, '添加评价', 1, 'com.ruoyi.web.controller.mall.MallCommentController.addComment()', 'POST', 1, 'zhangsan',
        'XXX大学', '/mall/comment/add', '127.0.0.1', '内网IP',
        '{\"commentId\":1,\"content\":\"很不错，超级赞。\",\"createTime\":\"2026-01-23 11:22:49\",\"goodsId\":1,\"params\":{},\"star\":3,\"userId\":104}',
        '{\"msg\":\"操作成功\",\"code\":200}', 0, NULL, '2026-01-23 11:22:50', 20),
       (303, '商品评价', 5, 'com.ruoyi.web.controller.mall.MallCommentController.export()', 'POST', 1, 'admin',
        'XXX大学', '/mall/comment/export', '127.0.0.1', '内网IP', '{\"pageSize\":\"10\",\"pageNum\":\"1\"}', NULL, 0,
        NULL, '2026-01-23 11:23:14', 380),
       (304, '创建订单', 1, 'com.ruoyi.web.controller.mall.MallOrderController.createOrder()', 'POST', 1, 'zhangsan',
        'XXX大学', '/mall/order/create', '127.0.0.1', '内网IP',
        '{\"createTime\":\"2026-01-27 10:39:07\",\"goodsId\":1,\"orderId\":3,\"orderNo\":\"20260127103907575013\",\"orderStatus\":\"0\",\"payStatus\":\"0\",\"quantity\":1,\"receiverAddress\":\"北京市西城区\",\"receiverName\":\"李四维\",\"receiverPhone\":\"13098987876\",\"totalAmount\":188.00,\"userId\":104}',
        '{\"msg\":\"下单成功\",\"code\":200,\"data\":\"20260127103907575013\"}', 0, NULL, '2026-01-27 10:39:07', 39);
/*!40000 ALTER TABLE `sys_oper_log`
    ENABLE KEYS */;
UNLOCK TABLES;
...
VALUES (1, 100, 'admin', '管理员', '00', 'ry@163.com', '15888888888', '1', '',
        '$2a$10$7JB720yubVSZvUI0rEqK/.VqGOZTH.ulu33dHOiBE8ByOhJIrdAu2', '0', '0', '127.0.0.1', '2026-01-29 15:43:31',
        'admin', '2024-02-28 22:23:42', '', '2026-01-29 15:43:30', '管理员', 333.20),
       (104, 100, 'zhangsan', '张三', '00', '', '13036856974', '0', '',
        '$2a$10$lfE/uN5HDx82NTuxXVbIauSOI26DwLQBPwMrO7zujNfAvlBA64SWS', '0', '0', '127.0.0.1', '2026-01-29 15:41:59',
        'admin', '2024-03-26 09:47:17', 'admin', '2026-01-29 15:41:58', NULL, NULL),
...
-- Dump completed on 2026-01-29 15:54:23
